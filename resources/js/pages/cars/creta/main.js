...
$(function () {
	...
	counterAnim
		.add('start')
		.to(count1, 2, { score: "+=123", roundProps: "score", onUpdate: count1.update.bind(count1), ease: Linear.easeNone }, 'start')
		.to(count2, 2, { score: "+=10", roundProps: "score", onUpdate: count2.update.bind(count2), ease: Linear.easeNone }, 'start')

	counterAnim2
		.add('start')
		.to(count3, 2, { score: "+=149", roundProps: "score", onUpdate: count3.update.bind(count3), ease: Linear.easeNone }, 'start')
