...
$(function () {
	...
	animC
		.staggerFrom('.dynamics--2 .dynamics__back--view1', 0.5, {
			opacity: 0
		}, 4)
	...
	counterAnim
		.add('start')
		.to(count1, 2, { score: "+=100", roundProps: "score", onUpdate: count1.update.bind(count1), ease: Linear.easeNone }, 'start')
		.to(count2, 2, { score: "+=12", roundProps: "score", onUpdate: count2.update.bind(count2), ease: Linear.easeNone }, 'start')

	counterAnim2
		.add('start')
		.to(count3, 2, { score: "+=123", roundProps: "score", onUpdate: count3.update.bind(count3), ease: Linear.easeNone }, 'start')
