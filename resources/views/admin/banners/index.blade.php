	...
	<table class="table">
		<caption>
			<div class="table__flex table__flex--caption">
				<h2 class="h2">Баннеры</h2>
				<a href="{{ route('admin.banners.create') }}" class="button button--small button--iconed">
					<span>
				...
				<td>
					<div class="table__flex">
						...
						<ul class="table__controls">
							<li>
								<a href="{{ route('admin.banners.show', ['banner' => $item->id]) }}" class="table__link">Изменить</a>
							</li>
							<li>
