<aside class="sidebar">
	<ul class="sidebar__list">
		<li class="sidebar__item">
			<a href="{{ route('admin.brandcollection_categories.index') }}" class="sidebar__link">
				...
				<span>Бренд-коллекция: категории</span>
			</a>
		</li>
		<li class="sidebar__item">
			<a href="{{ route('admin.brandcollection_tags.index') }}" class="sidebar__link">
				<div class="sidebar__icon">
				...
				<span>Бренд-коллекция: теги фильтра</span>
			</a>
		</li>
		<li class="sidebar__item">
			<a href="{{ route('admin.brandcollection_products.index') }}" class="sidebar__link">
				<div class="sidebar__icon">
					<svg width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M0 19C14.4 19 5.5 1 15.5 1C21.9 1 18.4 11 25.2 11H30" stroke="#666666" stroke-width="2" />
						<path d="M27.1486 6.59998L29.5555 10.4292C29.7728 10.7748 29.7728 11.2251 29.5555 11.5707L27.1486 15.4" stroke="#666666"
				...
				<span>Бренд-коллекция: продукция</span>
			</a>
		</li>
	</ul>
</aside>