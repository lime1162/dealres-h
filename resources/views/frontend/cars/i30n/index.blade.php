...
@section('scripts')
	...
	<script src="{{ mix('/js/cars/i30n_2019/i30n_2019.js') }}"></script>
	<script src="{{ mix('/js/cars/i30n_2019/main.js') }}"></script>
@endsection
