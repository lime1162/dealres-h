...
@section('pageTitle', 'Политика конфиденциальности')
	...
	<div class="row">
		<div class="col-md-12">
			<div class="legal__inner">
				...
				<br>
				<br>
				<h2 class="h3">1. Сбор ваших данных</h2>
				<p>
				...
				<br>
				<br>
				<h2 class="h3">2. Как мы собираем данные о ваших посещениях нашего сайта</h2>
				<p>
				...
				<br>
				<br>
				<h2 class="h3">3. Что мы будем делать с вашими личными данными</h2>
				<p>
				...
				<br>
				<br>
				<h2 class="h3">4. Как получить доступ к своим личным данным</h2>
				<p>
				...
				<br>
				<br>
				<h2 class="h3">5. Пользователи в возрасте до 18 лет включительно</h2>
				<p>
				...
				<br>
				<br>
				<h2 class="h3">7. Что такое веб-маяк?</h2>
				<p>
				...
				<p>
					Дополнительная информация о веб-маяках, их использовании и ваших правах доступна на сайте <a href="www.allaboutcookies.org/web-beacons/" target="_blank">www.allaboutcookies.org/web-beacons/</a>
				</p>
				<p>
				...
				<br>
				<br>
				<h2 class="h3">8. Ссылки на другие сайты</h2>
				<p>
