...
@section('styles')
    <link rel="stylesheet" href="/css/autolink/index.css">
@endsection
	...
	<div class="container-fluid df-main-banner__wrap">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="banner__inner df-main-banner__inner lazyload lazypreview" data-bgset="https://optimizator.hyundai.ru/images/autoLink/banner_mobile.jpg [(max-width: 640px)] | https://optimizator.hyundai.ru/images/autoLink/banner.jpg">
					...
					<div class="banner__buttons">
						<a target="_blank" href="https://apps.apple.com/ru/app/hyundai-auto-link/id1467685378" class="banner__button">
							<img src="https://optimizator.hyundai.ru/images/autoLink/app_store.svg" alt="">
						</a>
						<a target="_blank" href="https://play.google.com/store/apps/details?id=com.hyundai.autolink.ru" class="banner__button">
							<img src="https://optimizator.hyundai.ru/images/autoLink/play.svg" alt="">
						</a>
					</div>
				</div>
			</div>
...
@section('scripts')
    ...
    <script src="{{ mix('/js/autolink/libs.js') }}"></script>
@endsection
