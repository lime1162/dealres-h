...
@section('styles')
    <link rel="stylesheet" href="{{ mix('/dealer/css/service/libs.css') }}">
    <link rel="stylesheet" href="{{ mix('/dealer/css/service/service.css') }}">
@endsection
...
@section('scripts')
    <script src="{{ mix('/dealer/js/service/libs.js') }}"></script>
    <script src="{{ mix('/dealer/js/service/service-calculator.js') }}"></script>
    <script src="{{ mix('/dealer/js/service/service.js') }}"></script>
@endsection
