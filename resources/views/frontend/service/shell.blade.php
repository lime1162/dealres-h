...
@section('pageTitle', 'Моторные масла')

@section('styles')
    <link rel="stylesheet" href="{{ mix('/css/service/shell/libs.css') }}">
    <link rel="stylesheet" href="{{ mix('/css/service/shell/shell.css') }}">
@endsection
      ...
      <div class="col-md-12">
        <div class="head__banner">
          <div class="head__composition">
            ...
            <img src="https://optimizator.hyundai.ru/images/service/shell/shell.png" alt="" class="shell-logo">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="brand-inner">
          <img src="https://optimizator.hyundai.ru/images/service/shell/oil.png" alt="" class="brand__img">
          <img src="https://optimizator.hyundai.ru/images/service/shell/oil_mob.png" alt="" class="brand__img brand__img--mobile">
          ...
          <div class="selection__tablet">
            <fieldset class="model">
              ...
              <select id="js-model-select" class="df-select" id="model" name="model" placeholder="Выберите модель">
                <option></option>
                @foreach($data as $car)
                <option data-data='{"code":"{{ $car["name"]}}"}' value="{{ $car['image'] }}">{{ $car['name']}}</option>
                @endforeach
      ...
      <div class="col-md-12">
        ...
        <div class="choice__item" data-product="1">
          <div class="choice__item-img">
            <img src="https://optimizator.hyundai.ru/images/service/shell/01.png" alt="" class="choice__img">
            <!-- <img src="https://optimizator.hyundai.ru/images/service/shell/oil_mob1.png" alt="" class="choice__img choice__img--mobile"> -->
        ...
        <div class="choice__item" data-product="2">
          <div class="choice__item-img">
            <img src="https://optimizator.hyundai.ru/images/service/shell/04.png" alt="" class="choice__img">
            <!-- <img src="https://optimizator.hyundai.ru/images/service/shell/oil_mob1.png" alt="" class="choice__img choice__img--mobile"> -->
          </div>
          <div class="choice__item-info">
        ...
        <div class="choice__item" data-product="3">
          <div class="choice__item-img">
            <img src="https://optimizator.hyundai.ru/images/service/shell/05.png" alt="" class="choice__img">
            <!-- <img src="https://optimizator.hyundai.ru/images/service/shell/oil_mob1.png" alt="" class="choice__img choice__img--mobile"> -->
          </div>
          <div class="choice__item-info">
        ...
        <div class="choice__item" data-product="4">
          <div class="choice__item-img">
            <img src="https://optimizator.hyundai.ru/images/service/shell/03.png" alt="" class="choice__img">
            <!-- <img src="https://optimizator.hyundai.ru/images/service/shell/oil_mob1.png" alt="" class="choice__img choice__img--mobile"> -->
          </div>
          <div class="choice__item-info">
...
<div class="overlayed product-wrap" data-product="1">
	<div class="product-popup">
      ...
      <img src="https://optimizator.hyundai.ru/images/service/shell/01.png" alt="">
    </div>
    <div class="product__info">
      <div class="product__title">Shell Helix Ultra ECT AH 5W&#8209;30<img src="https://optimizator.hyundai.ru/images/service/shell/shell_logo.jpg" alt="" class="popup-logo"></div>
...
<div class="overlayed product-wrap" data-product="2">
	<div class="product-popup">
		<div class="product__img">
      <img src="https://optimizator.hyundai.ru/images/service/shell/04.png" alt="">
    </div>
    <div class="product__info">
      <div class="product__title">Shell Helix Ultra 0W&#8209;40<img src="https://optimizator.hyundai.ru/images/service/shell/shell_logo.jpg" alt="" class="popup-logo"></div>
      <p class="product__desc">Cинтетическое энергосберегающее моторное масло класса «премиум» для&nbsp;самых современных двигателей Hyundai, созданное на&nbsp;основе технологии Shell&nbsp;PurePlus и&nbsp;технологии активных моющих присадок. Разработано для&nbsp;бензиновых и&nbsp;дизельных двигателей (без&nbsp;сажевых фильтров) Hyundai.</p>
      <div>
        <ul id="accordion--product1" class="df-accordion popup-accordion">
          <li class="df-accordion__item">
...
<div class="overlayed product-wrap" data-product="3">
	<div class="product-popup">
		<div class="product__img">
      <img src="https://optimizator.hyundai.ru/images/service/shell/05.png" alt="">
    </div>
    <div class="product__info">
...
<div class="overlayed product-wrap" data-product="4">
	<div class="product-popup">
		<div class="product__img">
      <img src="https://optimizator.hyundai.ru/images/service/shell/03.png" alt="">
    </div>
    <div class="product__info">
...
<script type="text/javascript">
    var shellData = <?=json_encode($data)?>;
</script>
...
@section('scripts')
  <script src="{{ mix('/js/service/shell/libs.js') }}"></script>
  <script src="{{ mix('/js/service/shell/shell.js') }}"></script>
@endsection
